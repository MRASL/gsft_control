 ...
 * C++ source code generated on : Mon Mar 12 18:49:39 2018
 *
...
void scenario1_lqr1khzModelClass::step()
{
  ...
  if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M)) &&
     ...
     */
    scenario1_lqr1khz_B.u = 14.110137560749173 *
      scenario1_lqr1khz_B.RateTransition3[2] + 6.6677750177332396 *
   ...
   */
  scenario1_lqr1khz_B.Sum1 = 11.180339887498965 *
  ...
  if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M)) &&
     ...
     */
    scenario1_lqr1khz_B.u_j = 0.76307689413760071 *
      scenario1_lqr1khz_B.RateTransition3[0] + 0.59067772925478845 *
      scenario1_lqr1khz_B.RateTransition3[3];

    /* Gain: '<S6>/                     ' incorporates:
     *  SignalConversion: '<S6>/TmpSignal ConversionAt                     Inport1'
     */
    scenario1_lqr1khz_B.u_m = -0.748581262491583 *
      scenario1_lqr1khz_B.RateTransition3[1] + -0.56384058097390277 *
   ...
   */
  rtb_Sum1_g = 0.40824829046386274 * scenario1_lqr1khz_X.Integrator1_CSTATE_h -
   ...
   */
  rtb_Sum1 = -0.4082482904638608 * scenario1_lqr1khz_X.Integrator1_CSTATE_j -
   ...
   *  Sum: '<S4>/Sum1'
   */
  rtb_Sum1 = scenario1_lqr1khz_B.roll - (2.2930159453505423 *
    scenario1_lqr1khz_B.dX[6] + 0.40090751244658335 * scenario1_lqr1khz_B.dX[9]);
  rtb_Saturation1_idx_2 = scenario1_lqr1khz_B.pitch - (2.4906793140519019 *
    scenario1_lqr1khz_B.dX[7] + 0.4795230200074227 * scenario1_lqr1khz_B.dX[10]);
  rtb_Saturation1_idx_3 = 0.35355339059327257 *
    scenario1_lqr1khz_X.Integrator1_CSTATE_b - (0.55600362509376344 *
    scenario1_lqr1khz_B.dX[8] + 0.33112400750069654 * scenario1_lqr1khz_B.dX[11]);
