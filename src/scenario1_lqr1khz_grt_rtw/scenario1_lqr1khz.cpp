 ...
 * C++ source code generated on : Wed Mar  7 18:22:17 2018
 *
...
void scenario1_lqr1khzModelClass::step()
{
  ...
  if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M)) &&
     ...
     */
    scenario1_lqr1khz_B.u = 12.472497750532868 *
      scenario1_lqr1khz_B.RateTransition3[2] + 6.2781600068524233 *
   ...
   */
  scenario1_lqr1khz_B.Sum1 = 9.9999999999999467 *
  ...
  if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M)) &&
     ...
     */
    scenario1_lqr1khz_B.u_j = 0.42591767449266643 *
      scenario1_lqr1khz_B.RateTransition3[0] + 0.33281173089047339 *
      scenario1_lqr1khz_B.RateTransition3[3];

    /* Gain: '<S6>/                     ' incorporates:
     *  SignalConversion: '<S6>/TmpSignal ConversionAt                     Inport1'
     */
    scenario1_lqr1khz_B.u_m = -0.41175109205729166 *
      scenario1_lqr1khz_B.RateTransition3[1] + -0.30907792362075048 *
   ...
   */
  rtb_Sum1_g = 0.25000000000000372 * scenario1_lqr1khz_X.Integrator1_CSTATE_h -
   ...
   */
  rtb_Sum1 = -0.24999999999999606 * scenario1_lqr1khz_X.Integrator1_CSTATE_j -
   ...
   *  Sum: '<S4>/Sum1'
   */
  rtb_Sum1 = scenario1_lqr1khz_B.roll - (1.2905758791568442 *
    scenario1_lqr1khz_B.dX[6] + 0.30035193499872392 * scenario1_lqr1khz_B.dX[9]);
  rtb_Saturation1_idx_2 = scenario1_lqr1khz_B.pitch - (1.4622335723971729 *
    scenario1_lqr1khz_B.dX[7] + 0.36703171283873115 * scenario1_lqr1khz_B.dX[10]);
  rtb_Saturation1_idx_3 = 0.19364916731037096 *
    scenario1_lqr1khz_X.Integrator1_CSTATE_b - (0.35704591009751663 *
    scenario1_lqr1khz_B.dX[8] + 0.26460682310374156 * scenario1_lqr1khz_B.dX[11]);
