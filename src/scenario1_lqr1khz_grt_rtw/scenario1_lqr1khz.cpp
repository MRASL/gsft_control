...
void scenario1_lqr1khzModelClass::step()
{
...

  {
    ...
    /* Clock: '<Root>/Clock' */
    rtb_Clock = (&scenario1_lqr1khz_M)->Timing.t[0];
     ...
     */
    scenario1_lqr1khz_B.Sum1_l = 0.17320508075688992 *
      scenario1_lqr1khz_X.Integrator1_CSTATE_h - scenario1_lqr1khz_B.u_j;
    if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M)) &&
        (&scenario1_lqr1khz_M)->Timing.TaskCounters.TID[1] == 0) {
      /* ZeroOrderHold: '<Root>/Zero-Order Hold' */
      scenario1_lqr1khz_B.ZeroOrderHold = scenario1_lqr1khz_B.Sum1_l;
    }
     ...
     */
    scenario1_lqr1khz_B.Sum1_i = -0.173205080756885 *
      scenario1_lqr1khz_X.Integrator1_CSTATE_j - scenario1_lqr1khz_B.u_m;
    if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M)) &&
        (&scenario1_lqr1khz_M)->Timing.TaskCounters.TID[1] == 0) {
      /* ZeroOrderHold: '<Root>/Zero-Order Hold1' */
      scenario1_lqr1khz_B.ZeroOrderHold1 = scenario1_lqr1khz_B.Sum1_i;
    }
     ...
     *  Saturate: '<S4>/roll'
     */
    y = scenario1_lqr1khz_B.ZeroOrderHold1 * std::cos(scenario1_lqr1khz_U.X[8])
      + scenario1_lqr1khz_B.ZeroOrderHold * std::sin(scenario1_lqr1khz_U.X[8]);
    if (y > 0.52359877559829882) {
      y = 0.52359877559829882;
    } else {
      if (y < -0.52359877559829882) {
        y = -0.52359877559829882;
      }
     ...
     *  Sum: '<S4>/Sum1'
     */
    z = y - (1.1365283480217869 * scenario1_lqr1khz_B.dX[6] +
             0.28178545108770103 * scenario1_lqr1khz_B.dX[9]);
     ...
     *  Saturate: '<S6>/pitch'
     */
    y = -scenario1_lqr1khz_B.ZeroOrderHold1 * std::sin(scenario1_lqr1khz_U.X[8])
      + scenario1_lqr1khz_B.ZeroOrderHold * std::cos(scenario1_lqr1khz_U.X[8]);
    if (y > 0.52359877559829882) {
      y = 0.52359877559829882;
    } else {
      if (y < -0.52359877559829882) {
     ...
     *  Sum: '<S6>/Sum1'
     */
    y -= 1.2859205994736729 * scenario1_lqr1khz_B.dX[7] + 0.34413551249350854 *
      scenario1_lqr1khz_B.dX[10];
    psi = 0.15811388300841925 * scenario1_lqr1khz_X.Integrator1_CSTATE_b -
      (0.3035552054947866 * scenario1_lqr1khz_B.dX[8] + 0.24395632222527311 *
    ...
    for (i = 0; i < 6; i++) {
       ...
       *  Sum: '<Root>/Sum2'
       */
      scenario1_lqr1khz_B.u_h[i] = 0.0;
      scenario1_lqr1khz_B.u_h[i] += (scenario1_lqr1khz_B.ZeroOrderHold2 +
        15.107400000000002) * scenario1_lqr1khz_ConstP._Gain_m[i];
      scenario1_lqr1khz_B.u_h[i] += scenario1_lqr1khz_ConstP._Gain_m[i + 6] * z;
      scenario1_lqr1khz_B.u_h[i] += scenario1_lqr1khz_ConstP._Gain_m[i + 12] * y;
      scenario1_lqr1khz_B.u_h[i] += scenario1_lqr1khz_ConstP._Gain_m[i + 18] *
        psi;

      /* MATLAB Function: '<Root>/Actuator_Fault' */
      rtb_T_f[i] = scenario1_lqr1khz_B.u_h[i];
    }
    ...
    if (rtb_Clock >= 12.0) {
      ...
      rtb_T_f[0] = scenario1_lqr1khz_B.u_h[0];
      rtb_T_f[1] = scenario1_lqr1khz_B.u_h[1];
      rtb_T_f[2] = scenario1_lqr1khz_B.u_h[2];
      rtb_T_f[3] = scenario1_lqr1khz_B.u_h[3];
      rtb_T_f[4] = scenario1_lqr1khz_B.u_h[4];
      rtb_T_f[5] = scenario1_lqr1khz_B.u_h[5];
    }
    ...
    scenario1_lqr1khz_Y.virtual_control[0] = scenario1_lqr1khz_B.ZeroOrderHold2
      + 15.107400000000002;
    scenario1_lqr1khz_Y.virtual_control[1] = z;
    scenario1_lqr1khz_Y.virtual_control[2] = y;
    scenario1_lqr1khz_Y.virtual_control[3] = psi;
    for (i = 0; i < 6; i++) {
       ...
       *  Sum: '<Root>/Sum3'
       */
      y = (psi - 1250.0) * 0.022857142857142857;
      ...
      if (y > 200.0) {
        ...
        /* Outport: '<Root>/motor_command' */
        scenario1_lqr1khz_Y.motor_command[i] = y;
      }

      /* End of Saturate: '<Root>/Saturation' */

      /* Outport: '<Root>/motor_speed' */
      scenario1_lqr1khz_Y.motor_speed[i] = z;

      /* Outport: '<Root>/motor_RPM' */
      scenario1_lqr1khz_Y.motor_RPM[i] = psi;
    }
     ...
     */
    scenario1_lqr1khz_Y.ref[0] = rtb_Clock;
    scenario1_lqr1khz_Y.ref[1] = y;
    ...
    if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M)) &&
      ...
      /* Memory: '<S2>/Memory' */
      for (i = 0; i < 6; i++) {
        scenario1_lqr1khz_B.Memory[i] =
          scenario1_lqr1khz_DW.Memory_PreviousInput[i];
      }
     ...
     *  Inport: '<Root>/X'
     */
    if ((scenario1_lqr1khz_DW.TimeStampA >= (&scenario1_lqr1khz_M)->Timing.t[0])
        && (scenario1_lqr1khz_DW.TimeStampB >= (&scenario1_lqr1khz_M)->Timing.t
            [0])) {
      rtb_Sum1[0] = 0.0;
      rtb_Sum1[1] = 0.0;
      rtb_Sum1[2] = 0.0;
    } else {
      rtb_Clock = scenario1_lqr1khz_DW.TimeStampA;
      lastU = (real_T (*)[3])scenario1_lqr1khz_DW.LastUAtTimeA;
      if (scenario1_lqr1khz_DW.TimeStampA < scenario1_lqr1khz_DW.TimeStampB) {
        if (scenario1_lqr1khz_DW.TimeStampB < (&scenario1_lqr1khz_M)->Timing.t[0])
        {
          rtb_Clock = scenario1_lqr1khz_DW.TimeStampB;
          lastU = (real_T (*)[3])scenario1_lqr1khz_DW.LastUAtTimeB;
        }
      } else {
        if (scenario1_lqr1khz_DW.TimeStampA >= (&scenario1_lqr1khz_M)->Timing.t
            [0]) {
          rtb_Clock = scenario1_lqr1khz_DW.TimeStampB;
          lastU = (real_T (*)[3])scenario1_lqr1khz_DW.LastUAtTimeB;
        }
      ...
      rtb_Clock = (&scenario1_lqr1khz_M)->Timing.t[0] - rtb_Clock;
      rtb_Sum1[0] = (scenario1_lqr1khz_U.X[9] - (*lastU)[0]) / rtb_Clock;
      rtb_Sum1[1] = (scenario1_lqr1khz_U.X[10] - (*lastU)[1]) / rtb_Clock;
      rtb_Sum1[2] = (scenario1_lqr1khz_U.X[11] - (*lastU)[2]) / rtb_Clock;
    }
     ...
     */
    for (i = 0; i < 3; i++) {
      rtb_Product[i] = scenario1_lqr1khz_ConstP.Constant1_Value[i + 6] *
        rtb_Sum1[2] + (scenario1_lqr1khz_ConstP.Constant1_Value[i + 3] *
                       rtb_Sum1[1] + scenario1_lqr1khz_ConstP.Constant1_Value[i]
                       * rtb_Sum1[0]);
    }
     ...
     */
    for (i = 0; i < 3; i++) {
      rtb_Sum1[i] = scenario1_lqr1khz_ConstP.Constant1_Value[i + 6] *
        scenario1_lqr1khz_U.X[11] + (scenario1_lqr1khz_ConstP.Constant1_Value[i
        + 3] * scenario1_lqr1khz_U.X[10] +
        scenario1_lqr1khz_ConstP.Constant1_Value[i] * scenario1_lqr1khz_U.X[9]);
    }
    ...
    rtb_Clock = (scenario1_lqr1khz_U.X[10] * rtb_Sum1[2] -
                 scenario1_lqr1khz_U.X[11] * rtb_Sum1[1]) + rtb_Product[0];
    rtb_Product_idx_1 = (scenario1_lqr1khz_U.X[11] * rtb_Sum1[0] -
                         scenario1_lqr1khz_U.X[9] * rtb_Sum1[2]) + rtb_Product[1];
    rtb_Product_idx_2 = (scenario1_lqr1khz_U.X[9] * rtb_Sum1[1] -
                         scenario1_lqr1khz_U.X[10] * rtb_Sum1[0]) + rtb_Product
      [2];

    /* MATLAB Function: '<S2>/MATLAB Function1' */
    rtb_Sum1[0] = scenario1_lqr1khz_B.Memory[0] - scenario1_lqr1khz_B.Memory[3];
    rtb_Sum1[1] = scenario1_lqr1khz_B.Memory[1] - scenario1_lqr1khz_B.Memory[4];
    rtb_Sum1[2] = scenario1_lqr1khz_B.Memory[2] - scenario1_lqr1khz_B.Memory[5];
    for (i = 0; i < 3; i++) {
    ...
    scenario1_lqr1khz_Y.gamma[0] = 1.0 - (-rtb_Product[0] +
      scenario1_lqr1khz_B.Memory[0]) / scenario1_lqr1khz_B.Memory[0];
    scenario1_lqr1khz_Y.gamma[1] = 1.0 - (-rtb_Product[1] +
      scenario1_lqr1khz_B.Memory[1]) / scenario1_lqr1khz_B.Memory[1];
    scenario1_lqr1khz_Y.gamma[2] = 1.0 - (-rtb_Product[2] +
      scenario1_lqr1khz_B.Memory[2]) / scenario1_lqr1khz_B.Memory[2];

    /* Sum: '<Root>/Sum1' incorporates:
     *  Inport: '<Root>/X0'
     *  MATLAB Function: '<Root>/MATLAB Function'
     */
    scenario1_lqr1khz_B.d_ref[0] = rtb_FMxMyMz_idx_0 - scenario1_lqr1khz_U.X0[0];
    scenario1_lqr1khz_B.d_ref[1] = y - scenario1_lqr1khz_U.X0[1];
    ...
    if (scenario1_lqr1khz_B.d_ref[3] > 3.1415926535897931) {
      ...
      rtb_Clock = scenario1_lqr1khz_B.d_ref[3];
    }

    /* End of Saturate: '<S5>/yaw' */

    /* Sum: '<S5>/Sum3' */
    y = rtb_Clock - scenario1_lqr1khz_B.dX[8];

    /* Saturate: '<S5>/psi_e' */
    if (y > 0.78539816339744828) {
      scenario1_lqr1khz_B.psi_e = 0.78539816339744828;
    } else if (y < -0.78539816339744828) {
      scenario1_lqr1khz_B.psi_e = -0.78539816339744828;
    } else {
      scenario1_lqr1khz_B.psi_e = y;
    }
    ...
    if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M)) &&
      ...
      if (scenario1_lqr1khz_B.RateTransition > 1.0) {
        ...
        rtb_Clock = scenario1_lqr1khz_B.RateTransition;
      }

      /* End of Saturate: '<S7>/x' */

      /* Sum: '<S7>/Sum3' */
      y = rtb_Clock - scenario1_lqr1khz_B.RateTransition3[0];
      ...
      if (scenario1_lqr1khz_B.RateTransition1 > 1.0) {
        ...
        rtb_Clock = scenario1_lqr1khz_B.RateTransition1;
      }

      /* End of Saturate: '<S8>/y' */

      /* Sum: '<S8>/Sum3' */
      y = rtb_Clock - scenario1_lqr1khz_B.RateTransition3[1];
      ...
      if (scenario1_lqr1khz_B.RateTransition2 > 1.0) {
        ...
        rtb_Clock = scenario1_lqr1khz_B.RateTransition2;
      }

      /* End of Saturate: '<S9>/z' */

      /* Sum: '<S9>/Sum3' */
      y = rtb_Clock - scenario1_lqr1khz_B.RateTransition3[2];
  ...
  if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M))) {
    ...
    if (rtmIsMajorTimeStep((&scenario1_lqr1khz_M)) &&
      ...
      for (i = 0; i < 6; i++) {
        scenario1_lqr1khz_DW.Memory_PreviousInput[i] = scenario1_lqr1khz_B.u_h[i];
      }
     ...
     */
    if (scenario1_lqr1khz_DW.TimeStampA == (rtInf)) {
      scenario1_lqr1khz_DW.TimeStampA = (&scenario1_lqr1khz_M)->Timing.t[0];
      lastU = (real_T (*)[3])scenario1_lqr1khz_DW.LastUAtTimeA;
    } else if (scenario1_lqr1khz_DW.TimeStampB == (rtInf)) {
      scenario1_lqr1khz_DW.TimeStampB = (&scenario1_lqr1khz_M)->Timing.t[0];
      lastU = (real_T (*)[3])scenario1_lqr1khz_DW.LastUAtTimeB;
    } else if (scenario1_lqr1khz_DW.TimeStampA < scenario1_lqr1khz_DW.TimeStampB)
    {
      scenario1_lqr1khz_DW.TimeStampA = (&scenario1_lqr1khz_M)->Timing.t[0];
      lastU = (real_T (*)[3])scenario1_lqr1khz_DW.LastUAtTimeA;
    } else {
    ...
    (*lastU)[0] = scenario1_lqr1khz_U.X[9];
    (*lastU)[1] = scenario1_lqr1khz_U.X[10];
    (*lastU)[2] = scenario1_lqr1khz_U.X[11];
...
void scenario1_lqr1khzModelClass::initialize()
{
  ...
  /* states (dwork) */
  (void) memset((void *)&scenario1_lqr1khz_DW, 0,
                sizeof(DW_scenario1_lqr1khz_T));
...

  {
    ...
    for (i = 0; i < 6; i++) {
      scenario1_lqr1khz_DW.Memory_PreviousInput[i] = 2.5179000000000005;
    }

    /* End of InitializeConditions for Memory: '<S2>/Memory' */

    /* InitializeConditions for Derivative: '<S2>/Derivative' */
    scenario1_lqr1khz_DW.TimeStampA = (rtInf);
    scenario1_lqr1khz_DW.TimeStampB = (rtInf);
  }
}
