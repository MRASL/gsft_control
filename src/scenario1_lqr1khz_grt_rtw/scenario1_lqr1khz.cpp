 ...
 * C++ source code generated on : Thu Mar  8 14:44:27 2018
 *
...
void scenario1_lqr1khzModelClass::step()
{
   ...
   *  Inport: '<Root>/X'
   */
  rtb_Sum3_f = rtb_Sum1_c * std::cos(scenario1_lqr1khz_U.X[8]) + rtb_Sum1_g *
    std::sin(scenario1_lqr1khz_U.X[8]);
   ...
   *  Sum: '<S7>/Sum1'
   */
  rtb_ref_idx_1 = 10.000000000000018 * scenario1_lqr1khz_X.Integrator1_CSTATE -
   ...
   *  Sum: '<S4>/Sum1'
   */
  rtb_Sum1_c = rtb_Sum1_g - (1.2859205994736729 * rtb_VectorConcatenate[7] +
    0.34413551249350854 * rtb_VectorConcatenate[10]);
  rtb_ref_idx_3 = 0.15811388300841925 * scenario1_lqr1khz_X.Integrator1_CSTATE_b
   ...
   *  Sum: '<Root>/Sum2'
   */
  if (rtb_ref_idx_1 + 15.107400000000002 > 30.0) {
    rtb_Sum1_g = 30.0;
  } else if (rtb_ref_idx_1 + 15.107400000000002 < -0.0) {
    rtb_Sum1_g = -0.0;
  } else {
    rtb_Sum1_g = rtb_ref_idx_1 + 15.107400000000002;
  }

  if (rtb_Sum3_f > 2.0) {
    rtb_ref_idx_1 = 2.0;
  } else if (rtb_Sum3_f < -2.0) {
    rtb_ref_idx_1 = -2.0;
  } else {
    rtb_ref_idx_1 = rtb_Sum3_f;
  }
  ...
  scenario1_lqr1khz_Y.virtual_control[1] = rtb_ref_idx_1;
  scenario1_lqr1khz_Y.virtual_control[2] = rtb_Sum1_c;
  scenario1_lqr1khz_Y.virtual_control[3] = rtb_ref_idx_3;
  for (i = 0; i < 6; i++) {
    /* Gain: '<Root>/                 ' incorporates:
     *  Gain: '<Root>/      '
     */
    rtb_Sum3_f = scenario1_lqr1khz_ConstP._Gain_m[i + 18] * rtb_ref_idx_3 +
      (scenario1_lqr1khz_ConstP._Gain_m[i + 12] * rtb_Sum1_c +
       (scenario1_lqr1khz_ConstP._Gain_m[i + 6] * rtb_ref_idx_1 +
        scenario1_lqr1khz_ConstP._Gain_m[i] * rtb_Sum1_g));

    /* Sqrt: '<Root>/Sqrt1' incorporates:
     *  Gain: '<Root>/      '
     */
    rtb_Sqrt1 = std::sqrt(149253.73134328358 * rtb_Sum3_f);
     ...
     *  Sum: '<Root>/Sum3'
     */
    rtb_Sum3_f = (rtb_rads_to_RPM - 1250.0) * 0.022857142857142857;
    ...
    if (rtb_Sum3_f > 200.0) {
      ...
      /* Outport: '<Root>/motor_command' */
      scenario1_lqr1khz_Y.motor_command[i] = rtb_Sum3_f;
    }
  ...
  if (rtb_Sum1_g <= 15.0) {
    ...
    /* '<S1>:1:7' psi = X0(4); */
    rtb_ref_idx_3 = scenario1_lqr1khz_U.X0[3];
    ...
    rtb_ref_idx_3 = scenario1_lqr1khz_U.X0[3] + 1.5707963267948966;
  } else {
    /* '<S1>:1:23' else */
    /* '<S1>:1:24' x = X0(1)-1; */
    rtb_Sum1_g = scenario1_lqr1khz_U.X0[0] - 1.0;
   ...
   *  MATLAB Function: '<Root>/MATLAB Function'
   */
  rtb_ref_idx_1 = rtb_Sum1_c - scenario1_lqr1khz_U.X0[1];
   ...
   *  MATLAB Function: '<Root>/MATLAB Function'
   */
  rtb_Sum1_c = rtb_Sum3_f - scenario1_lqr1khz_U.X0[2];

  /* Outport: '<Root>/ref' incorporates:
   *  MATLAB Function: '<Root>/MATLAB Function'
   */
  scenario1_lqr1khz_Y.ref[3] = rtb_ref_idx_3;
  ...
  /* Sum: '<S3>/Sum3' */
  rtb_Sum3_f = rtb_ref_idx_3 - rtb_VectorConcatenate[8];
  ...
  if (rtb_Sum3_f > 0.78539816339744828) {
    ...
    scenario1_lqr1khz_B.psi_e = rtb_Sum3_f;
  }
  ...
  /* Sum: '<S5>/Sum3' */
  rtb_Sum3_f = rtb_Sum1_g - rtb_VectorConcatenate[0];
  ...
  if (rtb_Sum3_f > 1.0) {
    ...
    scenario1_lqr1khz_B.x_e = rtb_Sum3_f;
  }
  ...
  /* Sum: '<S6>/Sum3' */
  rtb_Sum3_f = rtb_ref_idx_1 - rtb_VectorConcatenate[1];
  ...
  if (rtb_Sum3_f > 1.0) {
    ...
    scenario1_lqr1khz_B.y_e = rtb_Sum3_f;
  }
  ...
  if (rtb_Sum3_f > 0.5) {
    ...
    scenario1_lqr1khz_B.z_e = rtb_Sum3_f;
  }
