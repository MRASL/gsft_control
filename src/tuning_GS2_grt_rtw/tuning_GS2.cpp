...
void tuning_GS2ModelClass::step()
{
...

  {
    ...
    /*  normalized LOE */
    /*  to change 2 */
    /* '<S29>:1:7' Kx = [2.0048   1.2289] +  [0.5179   0.2023]*LOE_M; */
    /* '<S29>:1:8' Kix = 1.4511 + 0.3746*LOE_M; */
    Kix = 0.3746 * LOE_M + 1.4511;
    ...
    /*  ------------------------------ */
    /*  Nominal gain: OK  */
    /*  K_x_SFint = [1.2426   0.7085];    Ki_x_SFint = 0.9913;    */
    /*  ------------------------------ */
    /*  evalSurf gain: OK                                   */
    /*  u = [0 0 0 0]                   => Kx = [1.4869    1.0266    1.0765]   % GS nominal !!! */
    /*  u = [0 0 0 0.3]                 => Kx = [2.0048    1.2289    1.4511]   % GS2 with LOE   */
    rtb_d_x = tuning_GS2_U.X[0] - tuning_GS2_U.Y0[0];

    /* MATLAB Function: '<S23>/MATLAB Function' */
    rtb_Kx = 0.5179 * LOE_M + 2.0048;
    ...
    /*  normalized LOE */
    /*  to change 2 */
    /* '<S26>:1:7' Ktheta = [4.1552   0.7788] +  [ 0.8640   0.2009]*LOE_M; */
    /*   */
    /*  KX = */
    /*    Columns 1 through 13 */
    /*           0         0   16.0821         0         0    9.4270         0         0         0         0         0         0         0 */
    ...
    /*  ------------------------------ */
    /*  Nominal gain: OK  */
    /*  K_pitch_SF  = [2.2946   0.4589];   */
    /*  ------------------------------ */
    /*  evalSurf gain: OK                                   */
    /*  u = [0 0 0 0]                   => Ktheta = [3.2912  0.5779]   % GS nominal     */
    /*  u = [0 0 0 0.3]                 => Ktheta = [4.1552  0.7788]   % GS2 with LOE   */
     ...
     *  Sum: '<S5>/Sum8'
     */
    LOE_M = (tuning_GS2_B.Fcn + rtb_ff_idx_1) - ((0.864 * LOE_M + 4.1552) *
      tuning_GS2_U.X[7] + (0.2009 * LOE_M + 0.7788) * tuning_GS2_U.X[10]);
    if (LOE_M > 2.0) {
      rtb_ref_idx_3 = 2.0;
    } else if (LOE_M < -2.0) {
      rtb_ref_idx_3 = -2.0;
