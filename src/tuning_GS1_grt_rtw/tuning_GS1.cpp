...
void tuning_GS1ModelClass::step()
{
...

  {
    ...
    static const real_T a_1[16] = { 0.04855, 0.03135, 0.03135, 0.03135, 0.1676,
      0.2236, 0.2236, 0.2236, 1.206, 1.629, 1.629, 1.629, 0.3819, 0.4795, 0.4795,
      0.4795 };

    static const real_T b_a[16] = { 0.03135, 0.04855, 0.03135, 0.03135, 0.2236,
      0.1676, 0.2236, 0.2236, 1.629, 1.206, 1.629, 1.629, 0.4795, 0.3819, 0.4795,
      0.4795 };

    static const real_T c_a[16] = { 0.03135, 0.03135, 0.04855, 0.03135, 0.2236,
      0.2236, 0.1676, 0.2236, 1.629, 1.629, 1.206, 1.629, 0.4795, 0.4795, 0.3819,
      0.4795 };

    static const real_T d_a[16] = { 0.03135, 0.03135, 0.03135, 0.04855, 0.2236,
      0.2236, 0.2236, 0.1676, 1.629, 1.629, 1.629, 1.206, 0.4795, 0.4795, 0.4795,
      0.3819 };

    static const real_T e_a[4] = { -0.1242, -0.003495, -0.003495, -0.003495 };

    static const real_T f_a[4] = { -0.003495, -0.1242, -0.003495, -0.003495 };

    static const real_T g_a[4] = { -0.003495, -0.003495, -0.1242, -0.003495 };

    static const real_T h_a[4] = { -0.003495, -0.003495, -0.003495, -0.1242 };
    ...
    static const real_T b_a_0[6] = { -0.2768, -0.5536, -0.2768, -0.2768, -0.5536,
      -0.2768 };
    ...
    /*  Kx0 = [a0 b0 c0 d0]   */
    /*  Kx1 = [a1 b1 c1 d1 */
    /* '<S18>:1:30' Kx1 = [0.04855   0.1676    1.206     0.3819        % Kx1 = [a1 b1 c1 d1 */
    /* '<S18>:1:31'            0.03135   0.2236    1.629     0.4795 ]; */
    /*         a2 b2 c2 d2] */
    /* '<S18>:1:32' Ki0 =  1.4669; */
    /*  Ki0 = i0 */
    /*  Ki1 = [i1 i2]' */
    /* '<S18>:1:33' Ki1 = [-0.1242                                     % Ki1 = [i1 i2]' */
    /* '<S18>:1:34'            -0.003495]; */
    /*          */
    /*  From GS2 synthesis */
    ...
    for (i = 0; i < 16; i++) {
      rtb_Kxtheta[i] = ((a_1[i] * rtb_gamma_m[0] + b_a[i] * rtb_gamma_m[2]) +
    ...
    for (i = 0; i < 6; i++) {
      rtb_gamma_m[i] = ((((b_a_0[i] * rtb_d_y + b_a_0[i] * rtb_ff_idx_0) +
                          b_a_0[i] * rtb_ff_idx_1) + b_a_0[i] * rtb_gamma_j) +
                        b_a_0[i] * rtb_gamma_j_0) + b_a_0[i] * rtb_gamma_j_1;
    }
