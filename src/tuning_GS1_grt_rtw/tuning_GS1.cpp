...
void tuning_GS1ModelClass::step()
{
...

  {
    ...
    static const real_T a_2[24] = { -0.4067, -0.8134, -0.4067, -0.4067, -0.8134,
      -0.4067, -0.353, -0.706, -0.353, -0.353, -0.706, -0.353, 1.413, 2.826,
      1.413, 1.413, 2.826, 1.413, 0.223, 0.446, 0.223, 0.223, 0.446, 0.223 };

    static const real_T b_a[6] = { -0.2235, -0.447, -0.2235, -0.2235, -0.447,
      -0.2235 };
    ...
    /*         i0y]     i2y]             i2y]      */
    /*  From GS1 synthesis */
    /*  Experiment LOE2 = 50% => little better than GS2 */
    /*      Ky0  = [-0.7441   -0.4155     1.3736   0.2517];         % Ky0 = [a0 b0 c0 d0]              */
    /*      Ky1  = [-0.3543   -0.07409    0.7785   0.2735           % Ky1 = [a1 b1 c1 d1 */
    /*              -0.2741   -0.2799     1.025    0.1905];         %        a2 b2 c2 d2] */
    /*      Kiy0 =  -0.5764;                                        % Kiy0 = i0 */
    /*      Kiy1 = [-0.053                                          % Kiy1 = [i1 i2]' */
    /*              -0.1279];   */
    /*  Gazebo better than above gains */
    /*      Ky0  = [-0.7441   -0.4155     1.3736   0.2517];         % Ky0 = [a0 b0 c0 d0]   */
    /*      Ky1  = [-0.2771   -0.2612     1.095    0.2021           % Ky1 = [a1 b1 c1 d1 */
    /*              -0.2771   -0.2612     1.095    0.2021];         %        a2 b2 c2 d2] */
    /*      Kiy0 =  -0.5764;                                        % Kiy0 = i0 */
    /*      Kiy1 = [-0.1429                                         % Kiy1 = [i1 i2]' */
    /*              -0.1429];   */
    /* '<S19>:1:53' Ky0  = [-0.7441   -0.4155     1.3736   0.2517]; */
    /*  Ky0 = [a0 b0 c0 d0]   */
    /*  Ky1 = [a1 b1 c1 d1 */
    /* '<S19>:1:54' Ky1  = [-0.4067   -0.353      1.413    0.223           % Ky1 = [a1 b1 c1 d1 */
    /* '<S19>:1:55'             -0.4067   -0.353      1.413    0.223 ]; */
    /*         a2 b2 c2 d2] */
    /* '<S19>:1:56' Kiy0 =  -0.5764; */
    /*  Kiy0 = i0 */
    /*  Kiy1 = [i1 i2]' */
    /* '<S19>:1:57' Kiy1 = [-0.2235                                         % Kiy1 = [i1 i2]' */
    /* '<S19>:1:58'             -0.2235]; */
    /*  From GS2 synthesis */
    ...
    /*              -0.2768];    */
    /* '<S19>:1:74' K_mapping0 = [1 2 1 1 2 1]'; */
    /* '<S19>:1:75' K_mapping1 = [1 0 0 0 0 0;0 2 1 1 2 1]'; */
    /* '<S19>:1:76' K_mapping2 = [0 2 0 0 0 0;1 0 1 1 2 1]'; */
    /* '<S19>:1:77' K_mapping3 = [0 0 1 0 0 0;1 2 0 1 2 1]'; */
    /* '<S19>:1:78' K_mapping4 = [0 0 0 1 0 0;1 2 1 0 2 1]'; */
    /* '<S19>:1:79' K_mapping5 = [0 0 0 0 2 0;1 2 1 1 0 1]'; */
    /* '<S19>:1:80' K_mapping6 = [0 0 0 0 0 1;1 2 1 1 2 0]'; */
    /* '<S19>:1:82' Kyphi = K_mapping1*Ky1*u(1) + K_mapping2*Ky1*u(2) + K_mapping3*Ky1*u(3) + K_mapping4*Ky1*u(4) + K_mapping5*Ky1*u(5) + K_mapping6*Ky1*u(6); */
    for (i = 0; i < 24; i++) {
    ...
    /* '<S19>:1:83' Kiy   = K_mapping1*Kiy1*u(1) + K_mapping2*Kiy1*u(2) + K_mapping3*Kiy1*u(3) + K_mapping4*Kiy1*u(4) + K_mapping5*Kiy1*u(5) + K_mapping6*Kiy1*u(6); */
     ...
     *  Inport: '<Root>/Y0'
     */
    /* '<S19>:1:85' gain = [Ky0(1:2) Kiy0] + [Kyphi(1,1:2) Kiy(1)]; */
