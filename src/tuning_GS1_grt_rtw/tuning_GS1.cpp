 ...
 *
 * Model version              : 1.2443
 * Simulink Coder version : 8.12 (R2017a) 16-Feb-2017
 * C++ source code generated on : Fri Aug  9 10:10:21 2019
 *
...
void tuning_GS1ModelClass::step()
{
...

  {
    ...
    static const real_T f_a_1[24] = { -0.2305, -0.461, -0.2305, -0.2305, -0.461,
      -0.1604, -0.2407, -0.4814, -0.2407, -0.2407, -0.4814, -0.2365, 1.079,
      2.158, 1.079, 1.079, 2.158, 0.6702, 0.1898, 0.3796, 0.1898, 0.1898, 0.3796,
      0.268 };

    static const real_T g_a_1[6] = { 0.0018, -0.1772, -0.0886, -0.0886, -0.1772,
      -0.0886 };

    static const real_T h_a_1[6] = { -0.0886, 0.0036, -0.0886, -0.0886, -0.1772,
      -0.0886 };
    ...
    for (i = 0; i < 24; i++) {
      rtb_Kyphi[i] = ((((a_2[i] * rtb_gamma_m[0] + b_a_1[i] * rtb_gamma_m[1]) +
