###########################################################################
## Makefile generated for Simulink model 'lqr_outer'. 
## 
## Makefile     : lqr_outer.mk
## Generated on : Wed Dec 20 17:57:52 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lqr_outer.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/ducnguyen/Documents/Hexa_Outer
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = lqr_outer_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lqr_outer.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/lqr_outer_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=lqr_outer -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/lqr_outer_grt_rtw/lqr_outer.cpp $(START_DIR)/lqr_outer_grt_rtw/lqr_outer_data.cpp
...
OBJS = lqr_outer.cpp.o lqr_outer_data.cpp.o
...
%.c.o : $(START_DIR)/lqr_outer_grt_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/lqr_outer_grt_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/lqr_outer_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
