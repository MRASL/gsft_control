...
bsl_hoveringModelClass gController;
...
void OdometryCallback(const nav_msgs::Odometry::ConstPtr &odom) {
  ...
  gController.bsl_hovering_U.X[0 ]  = odometry.position_W.x();
  gController.bsl_hovering_U.X[1 ]  = odometry.position_W.y();
...
/*  gController.bsl_hovering_U.X[3 ]  = odometry.velocity_B.x();
  ...
  gController.bsl_hovering_U.X[6 ]  = phi;
  gController.bsl_hovering_U.X[7 ]  = teta;
  gController.bsl_hovering_U.X[8 ]  = psi;
...
/*  Eigen::Matrix3d H;
  ...
  gController.bsl_hovering_U.X[9 ]  = euler_rate.x();
  gController.bsl_hovering_U.X[10]  = euler_rate.y();
  gController.bsl_hovering_U.X[11]  = euler_rate.z();
*/
  gController.bsl_hovering_U.X[9 ]  = odometry.angular_velocity_B.x();
  gController.bsl_hovering_U.X[10]  = odometry.angular_velocity_B.y();
  gController.bsl_hovering_U.X[11]  = odometry.angular_velocity_B.z();
}
...
/*void MultiDofJointTrajectoryCallback(
    ...
    gController.bsl_hovering_U.z_ref    = eigen_reference.position_W.z();
...
/*void CommandPoseCallback(const geometry_msgs::PoseStampedConstPtr& pose_msg) {
  ...
  gController.bsl_hovering_U.x_ref    = eigen_reference.position_W.x();
  gController.bsl_hovering_U.y_ref    = eigen_reference.position_W.y();
  gController.bsl_hovering_U.z_ref    = eigen_reference.position_W.z();
  gController.bsl_hovering_U.psi_ref  = 0.0;
  if (!gCommand_active){
    gCommand_active      = true;
  }
}
...
int main(int argc, char** argv) {
  ros::init(argc, argv, "bsl_hovering_controller_node");
  ros::NodeHandle nh;
  ros::NodeHandle pnh("~");
  ROS_INFO("bsl_hovering_controller_node main started");
  ...
  while(ros::ok()) {
    if (gCommand_active) {
        ...
        for(unsigned int i=0; i< 6; i++) {
            ...
            {
              motor_RPM[i]     = gController.bsl_hovering_Y.motor_RPM[i]*(1.0 - gLOE[i]);
              motor_command[i] = gController.bsl_hovering_Y.motor_command[i]*(1.0 - gLOE[i]);
              motor_speed[i]   = gController.bsl_hovering_Y.motor_speed[i]*(1.0 - gLOE[i]);
            }
        }
    ...
    uav_state_msg->position_W.z  = gController.bsl_hovering_U.X[2];
    uav_state_msg->velocity_B.x  = gController.bsl_hovering_U.X[3];
    uav_state_msg->velocity_B.y  = gController.bsl_hovering_U.X[4];
    uav_state_msg->velocity_B.z  = gController.bsl_hovering_U.X[5];
    uav_state_msg->euler_angle.x = gController.bsl_hovering_U.X[6];
    uav_state_msg->euler_angle.y = gController.bsl_hovering_U.X[7];
    uav_state_msg->euler_angle.z = gController.bsl_hovering_U.X[8];
    uav_state_msg->rotation_speed_B.x  = gController.bsl_hovering_U.X[9];
    uav_state_msg->rotation_speed_B.y  = gController.bsl_hovering_U.X[10];
    uav_state_msg->rotation_speed_B.z  = gController.bsl_hovering_U.X[11];
    uav_state_msg->total_thrust  = gController.bsl_hovering_Y.virtual_control[0];
    uav_state_msg->moment.x      = gController.bsl_hovering_Y.virtual_control[1];
    uav_state_msg->moment.y      = gController.bsl_hovering_Y.virtual_control[2];
    uav_state_msg->moment.z      = gController.bsl_hovering_Y.virtual_control[3];

    uav_state_msg->LOE13.x  = gController.bsl_hovering_Y.gamma[0];
    uav_state_msg->LOE13.y  = gController.bsl_hovering_Y.gamma[1];
    uav_state_msg->LOE13.z  = gController.bsl_hovering_Y.gamma[2];
    uav_state_msg->LOE46.x  = gController.bsl_hovering_Y.gamma[3];
    uav_state_msg->LOE46.y  = gController.bsl_hovering_Y.gamma[4];
    uav_state_msg->LOE46.z  = gController.bsl_hovering_Y.gamma[5];
    ...
    if (gEmergency_status)
    {
      ...
      ROS_ERROR("bsl_hovering_controller_node Emergency status");
