###########################################################################
## Makefile generated for Simulink model 'lqr_final'. 
## 
## Makefile     : lqr_final.mk
## Generated on : Thu Dec 21 08:40:28 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lqr_final.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/ducnguyen/Documents/Test_Asctec_Firefly/Hexa_Final
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = lqr_final_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lqr_final.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/lqr_final_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=lqr_final -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/lqr_final_grt_rtw/lqr_final.cpp $(START_DIR)/lqr_final_grt_rtw/lqr_final_data.cpp
...
OBJS = lqr_final.cpp.o lqr_final_data.cpp.o
...
%.c.o : $(START_DIR)/lqr_final_grt_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/lqr_final_grt_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/lqr_final_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
