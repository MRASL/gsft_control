...
class scenario1_gsModelClass {
 ...
 private:
  ...
  /* Block states */
  DW_scenario1_gs_T scenario1_gs_DW;
 ...
 * '<S2>'   : 'scenario1_gs/FDD'
 * '<S3>'   : 'scenario1_gs/FDD  '
 * '<S4>'   : 'scenario1_gs/MATLAB Function'
 * '<S5>'   : 'scenario1_gs/MATLAB Function2'
 * '<S6>'   : 'scenario1_gs/phi_controller1'
 * '<S7>'   : 'scenario1_gs/psi_controller '
 * '<S8>'   : 'scenario1_gs/teta_controller1'
 * '<S9>'   : 'scenario1_gs/x_controller '
 * '<S10>'  : 'scenario1_gs/y_controller '
 * '<S11>'  : 'scenario1_gs/z_controller '
 * '<S12>'  : 'scenario1_gs/FDD  /Cross Product'
 * '<S13>'  : 'scenario1_gs/FDD  /MATLAB Function1'
 * '<S14>'  : 'scenario1_gs/FDD  /Cross Product/Subsystem'
 * '<S15>'  : 'scenario1_gs/FDD  /Cross Product/Subsystem2'
 */
