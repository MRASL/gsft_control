...
/*  ros::Subscriber cmd_pose_sub_;                    // references (position and yaw)
  ...
  /*  uav_state_msg->x_ref         = gController.lqr_inner_Y.x_ref;
    uav_state_msg->y_ref         = gController.lqr_inner_Y.y_ref;
    uav_state_msg->z_ref         = gController.lqr_inner_Y.z_ref;
    uav_state_msg->heading_ref   = gController.lqr_inner_Y.psi_ref;*/
