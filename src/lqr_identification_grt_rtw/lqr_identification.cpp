...
void lqr_identificationModelClass::step()
{
  ...
  for (i_0 = 0; i_0 < 4; i_0++) {
     ...
     *  Sum: '<Root>/Sum'
     */
    u0 = lqr_identification_ConstP._Gain[i_0 + 12] *
     ...
     *  Sum: '<Root>/Sum'
     */
    rtb_Sum2[i_0] = (u0 - tmp[i_0]) + lqr_identification_ConstP._Value[i_0];
  }
  ...
  for (i_0 = 0; i_0 < 6; i_0++) {
     ...
     *  Gain: '<Root>/Gain2'
     */
    u0 = lqr_identification_ConstP.Gain_Gain[i_0 + 18] * rtb_Sum2[3] +
     ...
     *  Gain: '<Root>/Gain2'
     */
    currentTime = std::sqrt(116978.4923343994 * u0);

    /* Gain: '<Root>/rads_to_RPM' */
    currentTime_0 = 9.5493 * currentTime;

    /* Gain: '<Root>/mapping_0_200' incorporates:
     *  Constant: '<Root>/Constant1'
     *  Sum: '<Root>/Sum3'
     */
    u0 = (currentTime_0 - 1250.0) * 0.022857142857142857;
    ...
    if (u0 > 200.0) {
      ...
      /* Outport: '<Root>/motor_command' */
      lqr_identification_Y.motor_command[i_0] = u0;
    }

    /* End of Saturate: '<Root>/Saturation' */

    /* Outport: '<Root>/motor_speed' */
    lqr_identification_Y.motor_speed[i_0] = currentTime;

    /* Outport: '<Root>/motor_RPM' */
    lqr_identification_Y.motor_RPM[i_0] = currentTime_0;
  }

  /* Step: '<Root>/                  ' */
  currentTime = (&lqr_identification_M)->Timing.t[0];

  /* Step: '<Root>/z_ref' */
  currentTime_0 = (&lqr_identification_M)->Timing.t[0];

  /* Step: '<Root>/x_ref1' */
  currentTime_1 = (&lqr_identification_M)->Timing.t[0];

  /* Step: '<Root>/y_ref1' */
  currentTime_2 = (&lqr_identification_M)->Timing.t[0];

  /* Sum: '<Root>/Sum1' incorporates:
   *  Inport: '<Root>/X'
   *  Step: '<Root>/x_ref1'
   */
  u0 = (real_T)!(currentTime_1 < 20.0) - lqr_identification_U.X[0];
   ...
   *  Step: '<Root>/y_ref1'
   */
  u0 = (real_T)!(currentTime_2 < 30.0) - lqr_identification_U.X[1];
   ...
   *  Step: '<Root>/                  '
   */
  u0 = (real_T)(currentTime < 60.0) * currentTime_0 - lqr_identification_U.X[2];
  ...
  /* Step: '<Root>/psi' */
  if (currentTime_1 < 40.0) {
    currentTime = 0.0;
  } else {
    currentTime = 0.52359877559829882;
  }
