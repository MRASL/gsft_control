 ...
 * C++ source code generated on : Tue Feb  6 18:36:21 2018
 *
...
void scenario1_lqrModelClass::step()
{
  ...
  if (rtmIsMajorTimeStep((&scenario1_lqr_M)) &&
     ...
     */
    scenario1_lqr_B.u = 0.17090491175135289 * scenario1_lqr_B.RateTransition5[0]
      + 0.16457604450019833 * scenario1_lqr_B.RateTransition5[3];
  }
   ...
   */
  scenario1_lqr_B.Sum1 = 0.081649658092773469 *
  ...
  if (rtmIsMajorTimeStep((&scenario1_lqr_M)) &&
     ...
     */
    scenario1_lqr_B.u_m = -0.2309020913762011 * scenario1_lqr_B.RateTransition5
      [1] + -0.19724832873562087 * scenario1_lqr_B.RateTransition5[4];
  }
   ...
   */
  scenario1_lqr_B.Sum1_i = -0.12247448713916113 *
   ...
   */
  scenario1_lqr_B.Sum1_a = 0.099999999999999825 *
    scenario1_lqr_X.Integrator1_CSTATE_b - (0.22949006235840863 *
    scenario1_lqr_B.dX[8] + 0.21332844360633149 * scenario1_lqr_B.dX[11]);
  if (rtmIsMajorTimeStep((&scenario1_lqr_M)) &&
      (&scenario1_lqr_M)->Timing.TaskCounters.TID[1] == 0) {
   ...
   *  Sum: '<S8>/Sum1'
   */
  z = 4.4721359549996036 * scenario1_lqr_X.Integrator1_CSTATE -
    (7.3046081160489154 * scenario1_lqr_B.dX[2] + 4.8474934757491654 *
   ...
   *  Sum: '<S3>/Sum1'
   */
  tmp = psi - (0.94145548410944069 * scenario1_lqr_B.dX[6] + 0.25679372750265128
   ...
   *  Sum: '<S5>/Sum1'
   */
  psi -= 0.906114082153115 * scenario1_lqr_B.dX[7] + 0.28954286830857351 *
  ...
  /* Sum: '<S4>/Sum3' */
  psi = rtb_Clock - scenario1_lqr_B.dX[8];
