 ...
 * C++ source code generated on : Wed Jan 31 10:32:51 2018
 *
...
void scenario1_lqrModelClass::step()
{
   ...
   *  Sum: '<S3>/Sum1'
   */
  psi = u0 - (1.1365283480217518 * scenario1_lqr_B.dX[6] + 0.28178545108769576 *
   ...
   *  Sum: '<S5>/Sum1'
   */
  u0 -= 1.2859205994736529 * scenario1_lqr_B.dX[7] + 0.3441355124935061 *
    scenario1_lqr_B.dX[10];
  tmp = 0.15811388300841872 * scenario1_lqr_X.Integrator1_CSTATE_b -
    (0.31372450116883577 * scenario1_lqr_B.dX[8] + 0.24799549900832987 *
