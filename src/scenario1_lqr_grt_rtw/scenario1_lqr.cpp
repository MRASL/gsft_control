 ...
 * C++ source code generated on : Tue Feb  6 16:44:24 2018
 *
...
void scenario1_lqrModelClass::step()
{
  ...
  if (rtmIsMajorTimeStep((&scenario1_lqr_M)) &&
     ...
     */
    scenario1_lqr_B.u = 0.31312578517367995 * scenario1_lqr_B.RateTransition5[0]
      + 0.25417198201077978 * scenario1_lqr_B.RateTransition5[3];
  }
   ...
   */
  scenario1_lqr_B.Sum1 = 0.17320508075689248 *
  ...
  if (rtmIsMajorTimeStep((&scenario1_lqr_M)) &&
     ...
     */
    scenario1_lqr_B.u_m = -0.31312578517367656 *
      scenario1_lqr_B.RateTransition5[1] + -0.25417198201077884 *
   ...
   */
  scenario1_lqr_B.Sum1_i = -0.17320508075688965 *
   ...
   */
  scenario1_lqr_B.Sum1_a = 0.15811388300841892 *
    scenario1_lqr_X.Integrator1_CSTATE_b - (0.30355520549478615 *
    scenario1_lqr_B.dX[8] + 0.24395632222527261 * scenario1_lqr_B.dX[11]);
  if (rtmIsMajorTimeStep((&scenario1_lqr_M)) &&
      (&scenario1_lqr_M)->Timing.TaskCounters.TID[1] == 0) {
   ...
   *  Sum: '<S8>/Sum1'
   */
  z = 10.000000000000002 * scenario1_lqr_X.Integrator1_CSTATE -
    (12.219481695651952 * scenario1_lqr_B.dX[2] + 6.2157866455186541 *
   ...
   *  Sum: '<S3>/Sum1'
   */
  tmp = psi - (1.136528348021798 * scenario1_lqr_B.dX[6] + 0.28178545108770187 *
   ...
   *  Sum: '<S5>/Sum1'
   */
  psi -= 1.1365283480218018 * scenario1_lqr_B.dX[7] + 0.28178545108770353 *
