 ...
 * C++ source code generated on : Wed Aug 22 15:22:16 2018
 *
...
void tunning_nominalModelClass::step()
{
...

  {
    ...
    tunning_nominal_B.att[0] = std::atan(rtb_Gain_a / rtb_Sum1_e);
    tunning_nominal_B.att[1] = std::atan(-((tunning_nominal_U.gain[5] *
      tunning_nominal_X.Integrator_CSTATE - (tunning_nominal_U.gain[3] * ayref_N
      + tunning_nominal_U.gain[4] * tunning_nominal_U.X[4])) * -9.81) / std::
      sqrt(rtb_Gain_a * rtb_Gain_a + rtb_Sum1_e * rtb_Sum1_e));
