...
class scenario2_lqrModelClass {
 ...
 private:
  ...
  /* Block states */
  DW_scenario2_lqr_T scenario2_lqr_DW;
 ...
 * '<S2>'   : 'scenario2_lqr/FDD  '
 * '<S3>'   : 'scenario2_lqr/MATLAB Function'
 * '<S4>'   : 'scenario2_lqr/phi_controller1'
 * '<S5>'   : 'scenario2_lqr/psi_controller '
 * '<S6>'   : 'scenario2_lqr/teta_controller1'
 * '<S7>'   : 'scenario2_lqr/x_controller '
 * '<S8>'   : 'scenario2_lqr/y_controller '
 * '<S9>'   : 'scenario2_lqr/z_controller '
 * '<S10>'  : 'scenario2_lqr/FDD  /Cross Product'
 * '<S11>'  : 'scenario2_lqr/FDD  /MATLAB Function1'
 * '<S12>'  : 'scenario2_lqr/FDD  /Cross Product/Subsystem'
 * '<S13>'  : 'scenario2_lqr/FDD  /Cross Product/Subsystem2'
 */
