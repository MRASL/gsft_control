...
void lqr_innerModelClass::step()
{
  ...
  tmp[1] = lqr_inner_U.X[5];
  tmp[2] = lqr_inner_U.X[6];
  tmp[3] = lqr_inner_U.X[7];
  tmp[4] = lqr_inner_U.X[9];
  tmp[5] = lqr_inner_U.X[10];
  for (i_0 = 0; i_0 < 3; i_0++) {
    ...
    tmp_0[i_0] = 0.0;
    for (i = 0; i < 6; i++) {
      tmp_0[i_0] += lqr_inner_ConstP._Gain_g[3 * i + i_0] * tmp[i];
    }
     ...
     *  Sum: '<Root>/Sum'
     */
    rtb_Sum2[i_0] = ((lqr_inner_ConstP._Gain[i_0 + 6] *
                      lqr_inner_X.Integrator_CSTATE[2] +
                      (lqr_inner_ConstP._Gain[i_0 + 3] *
                       lqr_inner_X.Integrator_CSTATE[1] +
                       lqr_inner_ConstP._Gain[i_0] *
                       lqr_inner_X.Integrator_CSTATE[0])) - tmp_0[i_0]) +
      lqr_inner_ConstP._Value[i_0];
  }
  ...
  for (i_0 = 0; i_0 < 6; i_0++) {
     ...
     *  Gain: '<Root>/Gain2'
     */
    rtb_Sqrt1 = std::sqrt(116978.4923343994 * (lqr_inner_ConstP.Gain_Gain[i_0 +
      12] * rtb_Sum2[2] + (lqr_inner_ConstP.Gain_Gain[i_0 + 6] * rtb_Sum2[1] +
   ...
   *  Inport: '<Root>/z_ref'
   */
  lqr_inner_B.Sum1[0] = lqr_inner_U.z_ref - lqr_inner_U.X[2];
  lqr_inner_B.Sum1[1] = 0.0 - lqr_inner_U.X[6];
  lqr_inner_B.Sum1[2] = 0.0 - lqr_inner_U.X[7];
  if (rtmIsMajorTimeStep((&lqr_inner_M))) {
...
void lqr_innerModelClass::lqr_inner_derivatives()
{
  ...
  _rtXdot->Integrator_CSTATE[0] = lqr_inner_B.Sum1[0];
  _rtXdot->Integrator_CSTATE[1] = lqr_inner_B.Sum1[1];
  _rtXdot->Integrator_CSTATE[2] = lqr_inner_B.Sum1[2];
}
...
void lqr_innerModelClass::initialize()
{
  ...
  (&lqr_inner_M)->Timing.stepSize0 = 0.016666666666666666;
