...
## Generated on : Mon Jan 08 08:00:32 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lqr_tracking.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/ducnguyen/Documents/gsft_test/src/gsft_control/Matlab_Asctec_Firefly/LQR_Tracking
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = lqr_tracking_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lqr_tracking.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/lqr_tracking_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=lqr_tracking -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/lqr_tracking_grt_rtw/lqr_tracking.cpp $(START_DIR)/lqr_tracking_grt_rtw/lqr_tracking_data.cpp
...
OBJS = lqr_tracking.cpp.o lqr_tracking_data.cpp.o
...
%.c.o : $(START_DIR)/lqr_tracking_grt_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/lqr_tracking_grt_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/lqr_tracking_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
